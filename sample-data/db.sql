/*
 ...
 Source Database       : webed_demo_onepage

 Target Server Type    : MySQL
 Target Server Version : 50630
 File Encoding         : utf-8

 Date: 01/20/2017 09:08:32 AM
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `plugins` VALUES ('1', 'webed-analytics', '1.0.3', '1', '1'), ('2', 'webed-backup', null, '0', '0'), ('3', 'webed-blocks', '1.0', '0', '0'), ('4', 'webed-blog', null, '0', '0'), ('5', 'webed-custom-fields', '2.0.6', '1', '1'), ('6', 'webed-dashboard-style-guide', null, '0', '0'), ('7', 'webed-ecommerce', null, '0', '0'), ('8', 'webed-ecommerce-coupons', null, '0', '0'), ('9', 'webed-ecommerce-customers', null, '0', '0'), ('10', 'webed-ecommerce-orders', null, '0', '0'), ('11', 'webed-ecommerce-product-attributes', null, '0', '0'), ('12', 'webed-ide', null, '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `themes` VALUES ('1', 'cosmetics', '0', '0', null), ('2', 'sedna', '1', '1', '1.0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES ('1', 'admin', 'admin@webed.com', '$2y$10$bdXhVPjR0u.tyzKfdC40NOgOGK5jdnUUkCmsMzDj5ptpBea4L74bC', 'Super Admin', 'Admin', '0', null, null, null, null, 'male', 'activated', null, null, '55KMQttGzJppt0xYq3VsM8y23cE1vYTjFI94Xn4rKBIvPvDFYcx2NI7StN6v', null, null, '2017-01-20 01:42:08', null, null, null, '2017-01-19 12:37:38', '2017-01-20 02:05:56');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `view_trackers` VALUES ('1', 'WebEd\\Base\\Pages\\Models\\Page', '1', '146');
COMMIT;
